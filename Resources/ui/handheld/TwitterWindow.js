...
//        ,rightNavButton: refreshButton
    ...
    var indicator = Ti.UI.createActivityIndicator({
        style: util.isiPhone()? Ti.UI.iPhone.ActivityIndicatorStyle.PLAIN : Ti.UI.ActivityIndicatorStyle.BIG_DARK
    });
    self.add(indicator);
    ...
    function openEntryWin(itemIndex) {
        ...
        var webIndicator = Ti.UI.createActivityIndicator({
            style: util.isiPhone()? Ti.UI.iPhone.ActivityIndicatorStyle.DARK : Ti.UI.ActivityIndicatorStyle.BIG_DARK
        });
...
// ##########################################
    ...
    function load(kind) {
        if(util.isAndroid() && ("older" == kind || "newer" == kind)) {
            indicator = Ti.UI.createActivityIndicator({style: util.isiPhone()? Ti.UI.iPhone.ActivityIndicatorStyle.DARK : Ti.UI.ActivityIndicatorStyle.BIG_DARK});
            self.add(indicator);
